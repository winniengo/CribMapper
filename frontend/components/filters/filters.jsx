...
//                 <button
//                   type="button"
//                   className={noFee ? "selected" : ""}
//                   onClick={this.handleSelect("noFee", updateFee)}>
//                   no broker fee
//                 </button>
//                 <button
//                   type="button"
//                   className={parking ? "selected" : ""}
//                   onClick={this.handleSelect("parking", updateParking)}>
//                   parking
//                 </button>
//               </div>
//             </div>
...
const Filters = ({ filters, tags, updateRent, updateFilter, resetFilters }) => {
